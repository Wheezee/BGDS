                                    ...
                                    <div class="card card-body bg-light">
                                        <form id="filterForm" method="GET" action="{{ route('residents.all-info') }}">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3 mb-3">
                                                    <label for="voter" class="form-label">Voter Status</label>
                                                    <select class="form-select" id="voter" name="voter">
                                                        <option value="">All</option>
                                                        <option value="Yes" {{ request('voter') == 'Yes' ? 'selected' : '' }}>Yes</option>
                                                        <option value="No" {{ request('voter') == 'No' ? 'selected' : '' }}>No</option>
                                                    </select>
                                                </div>
                                                <div class="col-md-3 mb-3">
