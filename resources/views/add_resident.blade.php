                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <select class="form-select" id="labor_status" name="labor_status">
                                                    <option value="">Select</option>
                                                    <option value="Employed" {{ old('labor_status') == 'Employed' ? 'selected' : '' }}>Employed</option>
                                                    <option value="Unemployed" {{ old('labor_status') == 'Unemployed' ? 'selected' : '' }}>Unemployed</option>
                                                    <option value="PWD" {{ old('labor_status') == 'PWD' ? 'selected' : '' }}>PWD</option>
                                                    <option value="OFW" {{ old('labor_status') == 'OFW' ? 'selected' : '' }}>OFW</option>
                                                    <option value="Solo Parent" {{ old('labor_status') == 'Solo Parent' ? 'selected' : '' }}>Solo Parent</option>
                                                    <option value="OSY" {{ old('labor_status') == 'OSY' ? 'selected' : '' }}>OSY</option>
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-section">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="text" class="form-control" id="family_group" name="family_group" value="{{ old('family_group') }}">
                                            </div>
                                            <div class="col-md-6 mb-3">
                                                <label for="household_id" class="form-label">Household ID</label>
                                                <input type="text" class="form-control" id="household_id" name="household_id" value="{{ old('household_id') }}">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-section">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="text" class="form-control" id="skin_complexion" name="skin_complexion" value="{{ old('skin_complexion') }}">
                                            </div>
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <select class="form-select" id="program_participation" name="program_participation">
                                                    <option value="">Select</option>
                                                    <option value="MCCT" {{ old('program_participation') == 'MCCT' ? 'selected' : '' }}>MCCT</option>
                                                    <option value="4PS" {{ old('program_participation') == '4PS' ? 'selected' : '' }}>4PS</option>
                                                    <option value="UCT" {{ old('program_participation') == 'UCT' ? 'selected' : '' }}>UCT</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 mb-3">
                                                ...
                                                <select class="form-select" id="resident_voter" name="resident_voter">
                                                    <option value="">Select</option>
                                                    <option value="Yes" {{ old('resident_voter') == 'Yes' ? 'selected' : '' }}>Yes</option>
                                                    <option value="No" {{ old('resident_voter') == 'No' ? 'selected' : '' }}>No</option>
                                                </select>
                                            </div>
                                            <div class="col-md-4 mb-3">
                                                <label for="year_last_voted" class="form-label">Year Last Voted</label>
                                                <input type="text" class="form-control" id="year_last_voted" name="year_last_voted" value="{{ old('year_last_voted') }}">
                                            </div>
                                        </div>
                                    </div>
